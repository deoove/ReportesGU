...
// ── Definición de campos (orden exacto del Excel original) ───────────────────
const CAMPOS = [
  'ods',
  'ubicacion_tecnica',
  'sem',
...
const LABELS = {
  ...
  rcc:                    'RCC',
  primera_lect:           '1° Lectura',
  aud:                    'AUD',
  consumo_cero:           'Consumo 0',
  integral:               'Integral',
  distrito:               'Distrito',
  analisis:               'Análisis',
  repite:                 'Repite',
  ...
  precinto:               'Precinto',
  pozo:                   'Pozo',
  valvula_retencion:      'Válvula Retención',
  estado_conexion:        'Estado de Conexión',
  tipo_caja:              'Tipo de Caja',
  movil:                  'Móvil',
  cx_libres:              'CX. Libres',
  observaciones:          'Observaciones',
  resuelve:               'Resuelve Si / No',
  motivo:                 'Motivo',
  ods_inconsistencia_rcc: 'ODS Inconsistencia RCC',
  zrec:                   'ZREC Si / No',
  ods_recambio:           'ODS Recambio',
  alto_consumo:           'Alto Consumo',
  fecha_comunicacion:     'Fecha de Comunicación al Usuario',
  nro_contacto:           'N° Contacto Alto Consumo',
};
...
function verDetalle(ods) {
  ...
  const sections = [
    { title: 'Identificación', fields: ['ods', 'ubicacion_tecnica', 'sem', 'bim', 'anio', 'distrito', 'exp_ref', 'nro_serie', 'material'] },
    { title: 'Generación',     fields: ['fecha_generacion', 'rcc', 'primera_lect', 'aud', 'consumo_cero', 'integral', 'analisis', 'repite'] },
    { title: 'Entrega',        fields: ['fecha_entrega', 'inspector'] },
    { title: 'Inspección',     fields: ['fecha_inspeccion', 'hora_llegada', 'hora_salida', 'lectura', 'funcionamiento', 'resid', 'actividad'] },
    { title: 'Condiciones',    fields: ['corte', 'precinto', 'pozo', 'valvula_retencion', 'estado_conexion', 'tipo_caja', 'movil', 'cx_libres'] },
    { title: 'Gestión',        fields: ['observaciones', 'resuelve', 'motivo', 'ods_inconsistencia_rcc', 'zrec', 'ods_recambio', 'alto_consumo', 'fecha_comunicacion', 'nro_contacto'] },
  ];
